...
ace.define(
  ...
  function (require, exports, module) {
    ...
    var SearchBox = /** @class */ (function () {
            ...
            [
              ...
              [
                "span",
                {
                  ...
                  class: "ace_button",
                  title: nls("CaseSensitive Search"),
                },
                "Aa",
              ],
              [
      ...
      SearchBox.prototype.find = function (
        skipCurrent,
        backwards,
        preventScroll,
      ) {
      ...
      SearchBox.prototype.updateCounter = function () {
        ...
        if (regex) {
          ...
          while ((m = regex.exec(value))) {
            ...
            if (!m[0]) {
              regex.lastIndex = last += lang.skipEmptyMatch(
                value,
                last,
                supportsUnicodeFlag,
              );
        ...
        this.searchCounter.textContent = nls("$0 of $1", [
          before,
          all > MAX_COUNT ? MAX_COUNT + "+" : all,
        ]);
      };
