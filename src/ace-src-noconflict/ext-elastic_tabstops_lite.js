    ...
    var ElasticTabstopsLite = /** @class */ (function () {
      ...
      ElasticTabstopsLite.prototype.processRows = function (rows) {
        ...
        for (var r = 0, rowCount = rows.length; r < rowCount; r++) {
          ...
          var cellWidths = this.$setBlockCellWidthsToMax(
            cellWidthObj.cellWidths,
          );
      ...
      ElasticTabstopsLite.prototype.$setBlockCellWidthsToMax = function (
        cellWidths,
      ) {
      ...
      ElasticTabstopsLite.prototype.$rightmostSelectionInCell = function (
        selectionColumns,
        cellRightEdge,
      ) {
        var rightmost = 0;
