    ...
    var Autocomplete = /** @class */ (function () {
        ...
        this.$firstOpenTimer = lang.delayedCall(
          /**@this{Autocomplete}*/ function () {
            var initialPosition =
              ...
              this.completionProvider.initialPosition;
            if (
              this.autoShown ||
      ...
      Autocomplete.prototype.$onPopupChange = function (hide) {
        if (this.inlineRenderer && this.inlineEnabled) {
          var completion = hide
            ? null
            : this.popup.getData(this.popup.getRow());
      ...
      Autocomplete.prototype.$onPopupRender = function () {
        ...
        if (
          ...
          for (
            ...
            if (
              completion &&
              (!inlineEnabled || completion.hideInlinePreview)
            ) {
              this.$seen(completion);
            }
          }
      ...
      Autocomplete.prototype.updateDocTooltip = function () {
        ...
        for (var i = 0; i < completersLength; i++) {
          ...
          if (
            completer.getDocTooltip &&
            selected.completerId === completer.id
          ) {
  ...
  function (require, exports, module) {
    ...
    var CommandBarTooltip = /** @class */ (function () {
      function CommandBarTooltip(parentNode, options) {
        ...
        try {
          for (
            var _b = __values(["mousedown", "mouseup", "click"]),
              _c = _b.next();
            !_c.done;
            _c = _b.next()
          ) {
      ...
      CommandBarTooltip.prototype.$setMoreOptionsVisibility = function (
        visible,
      ) {
        if (visible) {
