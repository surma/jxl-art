...
ace.define(
  ...
  function (require, exports, module) {
    ...
    (function () {
      ...
      this.handleKeyboard = function (data, hashId, key, keyCode) {
        if (
          ((hashId === 1 /*ctrl*/ || hashId === 8) /*command*/ &&
            key === "v") ||
          (hashId === 1 /*ctrl*/ && key === "y")
        )
          return null;
...
ace.define(
  ...
  function (require, exports, module) {
    ...
    var IncrementalSearch = /** @class */ (function (_super) {
      ...
      IncrementalSearch.prototype.highlightAndFindWithNeedle = function (
        moveToNext,
        needleUpdateFunc,
      ) {
        ...
        if (found) {
          ...
          this.$editor.selection.setRange(
            Range.fromPoints(
              shouldSelect ? this.$startPos : found.end,
              found.end,
            ),
          );
