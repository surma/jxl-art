            ...
            (function (global) {
              (function (global, factory) {
                ...
                function restArguments(func, startIndex) {
                  startIndex =
                    startIndex == null ? func.length - 1 : +startIndex;
                  return function () {
                ...
                var hasStringTagBug =
                  ...
                  isIE11 =
                    typeof Map !== "undefined" && hasObjectTag(new Map());
                ...
                function deepEq(a, b, aStack, bStack) {
                  ...
                  if (areArrays) {
                    ...
                    while (length--) {
                      key = _keys[length];
                      if (
                        !(has$1(b, key) && eq(a[key], b[key], aStack, bStack))
                      )
                        return false;
                    }
                  }
            ...
            var JSHINT = (function () {
              ...
              function checkLeftSideAssign(
                ...
                if (left.id === ".") {
                  ...
                  if (
                    state.funct["(scope)"].bindingtype(left.value) ===
                    "exception"
                  ) {
                    warning("W022", left);
                  }
                  ...
                  if (e && e.type === "(string)") {
                    ...
                    if (!state.option.sub && reg.identifier.test(e.value)) {
                      ...
                      if (s) {
                        ...
                        canUseDot =
                          e.value !== "eval" && e.value !== "arguments";
                      }
                ...
                while (index < length) {
                  ...
                  if (char === "y") {
                    ...
                    var hasInvalidEscape = (function (
                      ...
                      var hasInvalidGroup = groupReferences.some(
            ...
            var scopeManager = function (
              ...
              var scopeManagerInst = {
                ...
                unstack: function () {
                  ...
                  for (i = 0; i < usedBindingNameList.length; i++) {
                    ...
                    if (usedBinding) {
                      ...
                      _current["(bindings)"][usedBindingName]["(unused)"] =
                        false;
                ...
                validateParams: function (isArrow) {
                  ...
                  currentFunctParamScope["(params)"].forEach(
                ...
                block: {
                  ...
                  use: function (bindingName, token) {
                    ...
                    if (
                      ...
                      paramScope["(bindings)"][bindingName]["(type)"] ===
                        "param"
                    ) {
                      if (
                        !scopeManagerInst.funct.has(bindingName, {
                        ...
                        paramScope["(bindings)"][bindingName]["(unused)"] =
                          false;
                      }
                    }
                    ...
                    _current["(usages)"][bindingName]["(onlyUsedSubFunction)"] =
                      false;
                  ...
                  reassign: function (bindingName, token) {
                    ...
                    _current["(usages)"][bindingName]["(reassigned)"].push(
                      token,
                    );
                  },
