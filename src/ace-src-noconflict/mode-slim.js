      ...
      this.$rules = {
        start: [
          ...
          },
          {
            ...
            regex:
              "(" + identifier + ")(\\s*)([=:])(\\s*)" + functionRule.regex,
          },
          functionRule,
          {
            token: "variable",
  ...
  function (require, exports, module) {
    ...
    var ScssHighlightRules = function () {
      var properties = lang.arrayToMap(
        CssHighlightRules.supportType.split("|"),
      );
...
ace.define(
  ...
  function (require, exports, module) {
    ...
    var oop = require("../lib/oop");
    var TextMode = require("./text").Mode;
    var ScssHighlightRules =
      require("./scss_highlight_rules").ScssHighlightRules;
    var MatchingBraceOutdent =
      require("./matching_brace_outdent").MatchingBraceOutdent;
    var CssBehaviour = require("./behaviour/css").CssBehaviour;
    var CStyleFoldMode = require("./folding/cstyle").FoldMode;
...
ace.define(
  ...
  function (require, exports, module) {
    ...
    var oop = require("../lib/oop");
    var TextMode = require("./text").Mode;
    var SassHighlightRules =
      require("./sass_highlight_rules").SassHighlightRules;
    var FoldMode = require("./folding/coffee").FoldMode;
    var Mode = function () {
...
ace.define(
  ...
  function (require, exports, module) {
    ...
    var oop = require("../lib/oop");
    var TextMode = require("./text").Mode;
    var LessHighlightRules =
      require("./less_highlight_rules").LessHighlightRules;
    var MatchingBraceOutdent =
      require("./matching_brace_outdent").MatchingBraceOutdent;
    var CssBehaviour = require("./behaviour/css").CssBehaviour;
    var CssCompletions = require("./css_completions").CssCompletions;
...
ace.define(
  ...
  function (require, exports, module) {
    ...
    var oop = require("../lib/oop");
    var TextMode = require("./text").Mode;
    var SlimHighlightRules =
      require("./slim_highlight_rules").SlimHighlightRules;
    var Mode = function () {
      TextMode.call(this);
