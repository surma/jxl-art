ace.define(
  ...
  function (require, exports, module) {
    ...
    var FlixHighlightRules = function () {
      ...
      var declarations =
        "eff|def|law|enum|case|type|alias|class|instance|mod|let";
      var modifiers =
        "with|without|opaque|lazy|lawful|pub|override|sealed|static";
      var primitives =
        "Unit|Bool|Char|Float32|Float64|Int8|Int16|Int32|Int64|BigInt|String";
...
ace.define(
  ...
  function (require, exports, module) {
    ...
    var FlixHighlightRules =
      require("./flix_highlight_rules").FlixHighlightRules;
    var Mode = function () {
